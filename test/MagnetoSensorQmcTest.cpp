...
namespace MagnetoSensorsTest {
    ...
    using MagnetoSensors::QmcRange;
    using MagnetoSensors::QmcRange2G;
    using MagnetoSensors::QmcRange8G;
    using MagnetoSensors::QmcRate;
    using MagnetoSensors::QmcRate200Hz;
    using MagnetoSensors::QmcSampling128;
